...
$objPHPExcel->getSheet(4)->setTitle('Subestacion & Acometida');
...
$objPHPExcel->getActiveSheet()->setCellValue('H5', 'REPORTE FOTOGRAFICO ACOMETIDA');
...
$objPHPExcel->getActiveSheet()->setCellValue('H71', 'REPORTE FOTOGRAFICO ACOMETIDA');
...
$objPHPExcel->getActiveSheet()->setCellValue('E31', 'NICHO MEDIDORES FRONTAL');
...
$objPHPExcel->getActiveSheet()->setCellValue('M31', 'NICHO TERMOMAGNETICO POSTERIOR');
...
$objPHPExcel->getActiveSheet()->setCellValue('E46', 'MEDIDOR ELECTRICO LUZ');
...
$objPHPExcel->getActiveSheet()->setCellValue('M46', 'TERMOMAGNCTICO Y CUCHILLAS');
...
$objPHPExcel->getActiveSheet()->setCellValue('E61', 'SUBESTACION ELECTRICA');
...
$objPHPExcel->getActiveSheet()->setCellValue('M61', 'MUFA ACOMETIDA ELECTRICA');
...
$objPHPExcel->getActiveSheet()->setCellValue('D97', 'POSTE O BASE DC TRANSFORMADOR');
...
//FOTO8
$objPHPExcel->getActiveSheet()->getStyle('O97')->getFont()->setName('Arial black');
$objPHPExcel->getActiveSheet()->setCellValue('O97', 'ATERRIZAJE');
$objPHPExcel->getActiveSheet()->getStyle('O97')->getFont()->setSize(12);
$objPHPExcel->getActiveSheet()->getStyle('O97')->getFont()->getColor()->applyFromArray( array('rgb' => '1874CD') );
//FOTO9
$objPHPExcel->getActiveSheet()->getStyle('F112')->getFont()->setName('Arial black');
$objPHPExcel->getActiveSheet()->setCellValue('F112', 'OTROS');
$objPHPExcel->getActiveSheet()->getStyle('F112')->getFont()->setSize(12);
$objPHPExcel->getActiveSheet()->getStyle('F112')->getFont()->getColor()->applyFromArray( array('rgb' => '1874CD') );
//FOTO10
$objPHPExcel->getActiveSheet()->getStyle('O112')->getFont()->setName('Arial black');
$objPHPExcel->getActiveSheet()->setCellValue('O112', 'OTROS');
$objPHPExcel->getActiveSheet()->getStyle('O112')->getFont()->setSize(12);
$objPHPExcel->getActiveSheet()->getStyle('O112')->getFont()->getColor()->applyFromArray( array('rgb' => '1874CD') );
//FOTO11
$objPHPExcel->getActiveSheet()->getStyle('F127')->getFont()->setName('Arial black');
$objPHPExcel->getActiveSheet()->setCellValue('F127', 'OTROS');
...
$objPHPExcel->getActiveSheet()->setCellValue('O127', 'OTROS');
...
$objDrawing->setName('Logo');
$objDrawing->setDescription('Logo');
$objDrawing->setPath('./fotos/temporal/SUB NICHO MEDIDOR FRONTAL.JPG');
...
$objDrawing->setName('Logo');
$objDrawing->setDescription('Logo');
$objDrawing->setPath('./fotos/temporal/SUB NICHO TERMOMAGNETICO POSTERIOR.JPG');
...
$objDrawing->setName('Logo');
$objDrawing->setDescription('Logo');
$objDrawing->setPath('./fotos/temporal/SUB MEDIDOR DE LUZ.JPG');
...
$objDrawing->setName('Logo');
$objDrawing->setDescription('Logo');
$objDrawing->setPath('./fotos/temporal/SUB TERMOMAGNETICO Y CUCHILLAS.JPG');
...
$objDrawing->setName('Logo');
$objDrawing->setDescription('Logo');
$objDrawing->setPath('./fotos/temporal/SUB SUBESTACION ELECTRICA.JPG');
...
$objDrawing->setName('Logo');
$objDrawing->setDescription('Logo');
$objDrawing->setPath('./fotos/temporal/SUB ACOMETIDA ELECTRICA.JPG');
...
$objDrawing->setName('Logo');
$objDrawing->setDescription('Logo');
$objDrawing->setPath('./fotos/temporal/SUB POSTE O BASE DE TRANSFORMADOR.JPG');
...
$objDrawing->setName('Logo');
$objDrawing->setDescription('Logo');
$objDrawing->setPath('./fotos/temporal/SUB ATERRIZAJE.JPG');
...
$objDrawing->setName('Logo');
$objDrawing->setDescription('Logo');
$objDrawing->setPath('./fotos/temporal/SUB OTROS1.JPG');
...
$objDrawing->setName('Logo');
$objDrawing->setDescription('Logo');
$objDrawing->setPath('./fotos/temporal/SUB OTROS2.JPG');
...
$objDrawing->setName('Logo');
$objDrawing->setDescription('Logo');
$objDrawing->setPath('./fotos/temporal/SUB OTROS3.JPG');
...
$objDrawing->setName('Logo');
$objDrawing->setDescription('Logo');
$objDrawing->setPath('./fotos/temporal/SUB OTROS4.JPG');
