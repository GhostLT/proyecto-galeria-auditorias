...
$objPHPExcel->getSheet(3)->setTitle('Predio');
...
$objPHPExcel->getActiveSheet()->setCellValue('I5', 'REPORTE FOTOGRAFICO PREDIO');
...
$objPHPExcel->getActiveSheet()->setCellValue('I71', 'REPORTE FOTOGRAFICO PREDIO');
...
$objPHPExcel->getActiveSheet()->setCellValue('E31', 'VISTA FROTAL');
...
$objPHPExcel->getActiveSheet()->setCellValue('N31', 'VISTA POSTERIOR');
...
$objPHPExcel->getActiveSheet()->setCellValue('E46', 'PREDIO LATERAL IZQ');
...
$objPHPExcel->getActiveSheet()->setCellValue('N46', 'PREDIO LATERAL DER');
...
$objPHPExcel->getActiveSheet()->setCellValue('E61', 'PASADOR PRINCIPAL');
...
$objPHPExcel->getActiveSheet()->setCellValue('N61', 'PASADOR ADICIONAL	');
...
$objPHPExcel->getActiveSheet()->setCellValue('E97', 'CONCERTINA 1');
...
$objPHPExcel->getActiveSheet()->setCellValue('N97', 'CONCERTINA 2');
...
$objPHPExcel->getActiveSheet()->setCellValue('E112', 'PORTON DE ACCESO');
...
$objPHPExcel->getActiveSheet()->setCellValue('M112', 'PORTON DE ACCESO SECUNDARIA');
...
$objDrawing->setName('Logo');
$objDrawing->setDescription('Logo');
$objDrawing->setPath('./fotos/temporal/PREDIO VISTA FRONTAL.JPG');
...
$objDrawing->setName('Logo');
$objDrawing->setDescription('Logo');
$objDrawing->setPath('./fotos/temporal/PREDIO VISTA POSTERIOR.JPG');
...
$objDrawing->setName('Logo');
$objDrawing->setDescription('Logo');
$objDrawing->setPath('./fotos/temporal/PREDIO LATERAL IZQ.JPG');
...
$objDrawing->setName('Logo');
$objDrawing->setDescription('Logo');
$objDrawing->setPath('./fotos/temporal/PREDIO LATERAL DER.JPG');
...
$objDrawing->setName('Logo');
$objDrawing->setDescription('Logo');
$objDrawing->setPath('./fotos/temporal/PREDIO PASADOR PRINCIPAL.JPG');
...
$objDrawing->setName('Logo');
$objDrawing->setDescription('Logo');
$objDrawing->setPath('./fotos/temporal/PREDIO PASADOR ADICIONAL.JPG');
...
$objDrawing->setName('Logo');
$objDrawing->setDescription('Logo');
$objDrawing->setPath('./fotos/temporal/PREDIO CONCERTINA 1.JPG');
...
$objDrawing->setName('Logo');
$objDrawing->setDescription('Logo');
$objDrawing->setPath('./fotos/temporal/PREDIO CONCERTINA 2.JPG');
...
$objDrawing->setName('Logo');
$objDrawing->setDescription('Logo');
$objDrawing->setPath('./fotos/temporal/PREDIO PORTON DE ACCESO.JPG');
